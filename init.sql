...
('K', '2025-09-17', '2025年9月17日凌晨，我有点失眠，而且很想小叶，更加睡不着了，没想到的是老婆也失眠了，肯定被我传染了，还有被我的思念戳中了，这怎么不算一种同步呢？哈哈哈', '兴奋', UNIX_TIMESTAMP('2025-09-17') * 1000),
('K', '2025-10-01', '国庆节了，原本一起过的，可惜计划打乱了，不过还好，晚上可以一起看综艺。', '难过', UNIX_TIMESTAMP('2025-10-01') * 1000),
('K', '2025-10-01', '肚子有点疼，她说帮我揉揉，还是这是叶小花，她的宝宝，哈哈哈', '开心', UNIX_TIMESTAMP('2025-10-01') * 1000),
('K', '2025-10-02', '早上跟猪打视频，被阿姨看见了，猪慌忙解释说是跟王二，哈哈哈，笑死我了', '开心', UNIX_TIMESTAMP('2025-10-02') * 1000),
('K', '2025-10-03', '想她，心里和身体都想，想把她拉过来睡觉', '难过', UNIX_TIMESTAMP('2025-10-03') * 1000),
('K', '2025-10-14', '今天是宝宝的生日，希望她新的一年健健康康平平安安的。', '开心', UNIX_TIMESTAMP('2025-10-14') * 1000),
('K', '2025-11-05', '怎么能有这么脆弱的两个肠胃，成功取名wccp', '兴奋', UNIX_TIMESTAMP('2025-11-05') * 1000),
('K', '2025-11-05', '勾引猪，哈哈哈，还说有机会一起拍情侣写真私房照呢', '开心', UNIX_TIMESTAMP('2025-11-05') * 1000),
('K', '2025-11-07', '给猪点个冬日套餐，立冬了，吃点热乎的，正好放松一下，谁让她是我的猪宝呢', '甜蜜', UNIX_TIMESTAMP('2025-11-07') * 1000),
('K', '2025-11-09', '两人互相勾引，身体受不了了，好想贴贴', '甜蜜', UNIX_TIMESTAMP('2025-11-09') * 1000),
('K', '2025-11-12', '因为那个谁开始吵架了明明那个谁一点也不重要，可就是因为这样的人，开始吵架。', '难过', UNIX_TIMESTAMP('2025-11-12') * 1000),
('K', '2025-11-14', '还在吵，解释不信。', '难过', UNIX_TIMESTAMP('2025-11-14') * 1000),
('K', '2025-11-16', '她说了很多伤我的话，还闹分手，我解释了很多也没有用，眼睛都肿了', '难过', UNIX_TIMESTAMP('2025-11-16') * 1000),
('K', '2025-11-17', '给她写了份长信，还有噜噜今天也到了，希望能弥补一点吧。', '难过', UNIX_TIMESTAMP('2025-11-17') * 1000),
('K', '2025-11-18', '今天我生日，但是过的稀碎，也憔悴瘦了5斤，可能是我应得的吧', '难过', UNIX_TIMESTAMP('2025-11-18') * 1000),
('K', '2025-11-21', '去找她了，激动，而且我们和好了', '激动', UNIX_TIMESTAMP('2025-11-21') * 1000),
('K', '2025-12-30', '明天就去找她了，期待', '激动', UNIX_TIMESTAMP('2025-12-30') * 1000);
...
('Y', '2025-09-30', '马上就要国庆节啦！好开心啊，要和老婆看综艺，但是一想到本来我们是要一起玩的，顿时破防了', '开心', UNIX_TIMESTAMP('2025-09-30') * 1000);
-- 创建用户表（可选，用于未来扩展）
